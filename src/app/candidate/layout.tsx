...
export default function CandidateLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-['Arimo',sans-serif]">
      ...
      >
        <PermissionRouteGuard anyPermissions={['candidates_read', 'candidates_create', 'candidates_update', 'candidates_delete', 'view_all_candidates', 'view_assigned_candidates', 'add_candidate', 'edit_candidate', 'delete_candidate']}>
          {children}
